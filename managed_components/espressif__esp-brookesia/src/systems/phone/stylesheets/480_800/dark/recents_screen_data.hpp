...
constexpr ESP_Brookesia_RecentsScreenSnapshotData_t ESP_BROOKESIA_PHONE_480_800_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()
{
    return {
        .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(300, 660),
        .title = {
        ...
        .image = {
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(300, 600),
            .radius = 20,
        },
    };
}

constexpr ESP_Brookesia_RecentsScreenData_t ESP_BROOKESIA_PHONE_480_800_DARK_RECENTS_SCREEN_DATA()
{
    return {
        .main = {
        ...
        .snapshot_table = {
            ...
            .snapshot = ESP_BROOKESIA_PHONE_480_800_DARK_RECENTS_SCREEN_SNAPSHOT_DATA(),
        },
        .trash_icon = {
