...
/**
 * Создайте дисплей LCD с помощью драйвера ST7796.
 ...
 * @param send_color    зависящая от платформы функция для отправки данных пикселей на контроллерLCD(обычно используется передача DMA: необходимо реализовать «готовый» обратный вызов)
