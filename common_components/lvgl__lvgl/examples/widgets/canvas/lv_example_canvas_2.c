...
/**
 * Создайте прозрачный холст с прозрачностью
 */
void lv_example_canvas_2(void)
{
    ...
    /*Красный фон (в индексированных изображениях нет выделенного альфа-канала, поэтому LV_OPA_COVER игнорируется)*/
    lv_canvas_fill_bg(canvas, lv_palette_main(LV_PALETTE_BLUE), LV_OPA_COVER);

    /*Создайте отверстие на холсте*/
    int32_t x;
    int32_t y;
    for(y = 10; y < 20; y++) {
        for(x = 5; x < 75; x++) {
