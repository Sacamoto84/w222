...
void lv_example_chart_1(void)
{
    ...
    for(i = 0; i < 10; i++) {
        ...
        /*Непосредственно установить точки на «ser2»*/
    ...
    /* Цвет тени автоматически следует за цветом каждой серии.
     * поэтому ручное управление не требуется. */
