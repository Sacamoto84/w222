...
/*
 * Установите дляgcdVG_ENABLE_WRITEBUFFERзначение 1 для совместного доступа к памяти Linux Write.
 * Установите дляgcdVG_ENABLE_WRITEBUFFERзначение 0 для доступа к некэшируемой памяти Linux.
*/
...
/*
 * если установлено значение 1,vg_lite_hal_traceможет использовать для печати сообщений
*/
...
/*
 * Для системы Зефир
 * УстановитеgcdVG_ENABLE_DELAY_RESUMEна 1, чтобы включить функцию включения задержки.
*/
