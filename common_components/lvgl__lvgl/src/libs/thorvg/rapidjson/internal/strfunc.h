...
//! Пользовательский strlen(), который работает с разными типами символов.
/*! \tparam Ch Тип символа (например, char, wchar_t, короткий)
    \param s Входная строка, завершающаяся нулем.
    \return Количество символов в строке.
    \note Имеет ту же семантику, что и strlen() , возвращаемое значение не является количеством кодовых точек Юникода.
*/
...
//! Пользовательский strcmpn(), который работает с разными типами символов.
/*! \tparam Ch Тип символа (например, char, wchar_t, короткий)
