...
/* Нам нужно переопределить некоторые математические макросы с фиксированной точкой D2, чтобы теперьlv_precise_tбыл плавающим. */
#undef D2_FIX4
#undef D2_INT4
#undef D2_FLOOR4
#undef D2_CEIL4
...
/* Его также следует включить сюда перед другими файламиLVGLDave2D. */
#endif
