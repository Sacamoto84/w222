...
void lv_example_textarea_4(void)
{
    ...
    lv_style_set_pad_hor(&style_underline, 1); /* установить ширину курсора с помощью панели */
    lv_style_set_border_width(&style_underline, 3); /* установить толщину подчеркивания курсора */

    /* Полноблочный курсор со множеством стилей */
    ...
    lv_style_set_pad_all(&style_block, 1); /* установить ширину курсора с помощью панели */

    /* Создайте 3 независимых текстовых поля, каждое с уникальным стилем курсора. */
