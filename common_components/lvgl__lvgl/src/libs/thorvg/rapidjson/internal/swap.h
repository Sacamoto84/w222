...
//! Пользовательскийswap(), чтобы избежать зависимости от заголовка <алгоритм> C++.
/*! \tparam T Тип аргументов для замены должен быть создан только с использованием примитивного типа C++.
