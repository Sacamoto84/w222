...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_IMG_CARET_DOWN uint8_t img_caret_down_map[] = {
    ...
    /*Формат пикселей: Синий: 2 бита, Зеленый: 3 бита, Красный: 3 бита, Альфа-8 бит. */
    ...
    /*Формат пикселей: Синий: 5 бит, Зеленый: 6 бит, Красный: 5 бит, Альфа 8 бит.*/
    ...
    /*Формат пикселей: Синий: 8 бит, Зеленый: 8 бит, Красный: 8 бит, Альфа: 8 бит.*/
