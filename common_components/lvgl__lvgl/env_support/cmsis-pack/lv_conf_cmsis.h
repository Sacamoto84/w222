 ...
 * Конфигурационный файл для v9.5.0
 */
...
/** Поменяйте местами старшие и младшие байты для RGB565. */
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        /*включение гелиевого ускорения при обнаружении Арм-2Д и гелиевого устройства */
...
/*Включить сжатие/распаковку библиотеки LZ4*/
#ifndef LV_USE_LZ4
#   define LV_USE_LZ4  0
