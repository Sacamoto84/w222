...
/*Не используйте уровень 2, чтобы избежать случая, когда`malloc`по умолчанию возвращает выровненный указатель, и используйте большое значение, чтобы быть уверенным, что любые проблемы приводят к сбою.*/
