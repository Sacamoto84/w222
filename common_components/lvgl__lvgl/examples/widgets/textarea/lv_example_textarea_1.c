...
void lv_example_textarea_1(void)
{
    ...
    lv_obj_add_state(ta, LV_STATE_FOCUSED); /*Чтобы убедиться, что курсор виден*/
    ...
    lv_obj_remove_flag(btnm, LV_OBJ_FLAG_CLICK_FOCUSABLE); /*Чтобы текстовая область была сосредоточена на нажатиях кнопок*/
