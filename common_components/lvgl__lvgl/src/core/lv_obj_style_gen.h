 ...
 * По умолчанию: Зависит от виджета, наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 ...
 * По умолчанию: 0, наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * относятся к ширине области содержимого родительского элемента.
 * По умолчанию: LV_COORD_MAX , наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
...
/**
 * Его значение зависит от типа виджета. Например, в случае `lv_scale` это означает
 * длина тиков.
 * По умолчанию: 0, наследуется: Нет, макет: Нет, доп. отрисовка: Да.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * направление.
 * По умолчанию: `LV_ALIGN_DEFAULT` , наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: 0, наследуется: Нет, макет: Да, доп. отрисовка: Да.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: 0, наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `0xffffff` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_OPA_TRANSP` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `0x000000` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_GRAD_DIR_NONE` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: 255, наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `NULL` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * an `LV_SYMBOL_...`.
 * По умолчанию: `NULL` , наследуется: Нет, макет: Нет, доп. отрисовка: Да.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_OPA_COVER` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_BORDER_SIDE_FULL` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * прозрачный, 255, `LV_OPA_100` или `LV_OPA_COVER` означает полное покрытие, другие значения
 * или LV_OPA_10 , LV_OPA_20 и т. д. означает полупрозрачность.
 * По умолчанию: `LV_OPA_COVER` , наследуется: Нет, макет: Нет, доп. отрисовка: Да.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
...
/**
 * Получите определение цвета ключа изображения. `lv_image_colorkey_t` содержит два значения цвета:
...
/**
 * Делает конечные точки линий закругленными.  `true`: закругленное окончание, `false`: обычное окончание линии.
 * По умолчанию: 0, наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
...
/**
 * Делает конечные точки закругленными.  `true`: закругленное окончание, `false`: обычное окончание линии.
 * По умолчанию: 0, наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `0x000000` , наследуется: Да, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * прозрачный, 255, `LV_OPA_100` или `LV_OPA_COVER` означает полное покрытие, другие значения
 * или LV_OPA_10 , LV_OPA_20 и т. д. означает полупрозрачность.
 * По умолчанию: `LV_OPA_COVER` , наследуется: Да, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_FONT_DEFAULT` , наследуется: Да, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: 0, наследуется: Да, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_TEXT_DECOR_NONE` , наследуется: Да, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_TEXT_ALIGN_AUTO` , наследуется: Да, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
...
/**
 * При этом приводится размывание. Применяется к каждой `lv_part` отдельно перед
 * дети оказываются.
 * По умолчанию: `0` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 ...
 * По умолчанию: `false` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_BLUR_QUALITY_AUTO` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * качество.  `LV_BLUR_QUALITY_PRECISION` заставит использовать более высокое качество, но медленнее.
 * размытие. При использовании `LV_BLUR_QUALITY_AUTO` качество будет выбрано автоматически.
 * По умолчанию: `LV_BLUR_QUALITY_PRECISION` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_BLEND_MODE_NORMAL` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_BASE_DIR_AUTO` , наследуется: Да, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `256` , наследуется: Да, макет: Нет, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_FLEX_FLOW_NONE` , наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_FLEX_ALIGN_NONE` , наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `NULL` , наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: `LV_GRID_ALIGN_START` , наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * По умолчанию: 1, наследуется: Нет, макет: Да, доп. отрисовка: Нет.
 * @param  obj    Указатель на виджет
 * @param  part   Одно из значений перечисления `LV_PART_...`
 */
 ...
 * @param  selector   Комбинация `lv_part_t` и `lv_state_t`. Примеры значений:
...
/**
 * Установите определение цвета клавишей изображения. `lv_image_colorkey_t` содержит два значения цвета:
 * `high_color` и`low_color`. цвет изображения от`low_color`до
 * `high_color` будет прозрачнее.
 * По умолчанию: `NULL` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj        Указатель на виджет
...
/**
 * Конфигуратор включает размытие. Применяется к каждой `lv_part` отдельно перед
 * дети оказываются.
 * По умолчанию: `0` , наследуется: Нет, макет: Нет, доп. отрисовка: Нет.
 * @param  obj        Указатель на виджет
 * @param  value      Новое значение
